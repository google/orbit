...
const CaptureCompleteData kTestCompleteData{
    ...
    OrbitCaptureData::
        TARGET_PROCESS_STATE_AFTER_CAPTURE_CRASHED, /*target_process_state_after_capture*/
    OrbitCaptureData::
        TARGET_PROCESS_TERMINATION_SIGNAL_SIGILL /*target_process_termination_signal*/};
