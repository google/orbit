...
class LostAndDiscardedEventVisitor : public PerfEventVisitor {
 public:
  ...
  void Visit(uint64_t event_timestamp, const LostPerfEvent& event_data) override {
  ...
  void Visit(uint64_t event_timestamp, const DiscardedPerfEvent& event_data) override {
