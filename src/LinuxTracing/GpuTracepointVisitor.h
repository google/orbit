...
class GpuTracepointVisitor : public PerfEventVisitor {
 public:
  ...
  void Visit(uint64_t event_timestamp, const AmdgpuCsIoctlPerfEvent& event_data) override;
  void Visit(uint64_t event_timestamp, const AmdgpuSchedRunJobPerfEvent& event_data) override;
  void Visit(uint64_t event_timestamp, const DmaFenceSignaledPerfEvent& event_data) override;
