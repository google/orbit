...
void UprobesUnwindingVisitor::Visit(uint64_t event_timestamp,
                                    const StackSamplePerfEvent& event_data) {
...
void UprobesUnwindingVisitor::Visit(uint64_t event_timestamp,
                                    const CallchainSamplePerfEvent& event_data) {
  CHECK(listener_ != nullptr);
  CHECK(current_maps_ != nullptr);
...
void UprobesUnwindingVisitor::Visit(uint64_t event_timestamp, const UprobesPerfEvent& event_data) {
...
void UprobesUnwindingVisitor::Visit(uint64_t event_timestamp,
                                    const UretprobesPerfEvent& event_data) {
...
void UprobesUnwindingVisitor::Visit(uint64_t event_timestamp, const MmapPerfEvent& event_data) {
  CHECK(listener_ != nullptr);
  CHECK(current_maps_ != nullptr);
