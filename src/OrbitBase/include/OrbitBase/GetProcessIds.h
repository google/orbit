...
#ifndef ORBIT_BASE_GET_PROCESS_IDS_H
#define ORBIT_BASE_GET_PROCESS_IDS_H
...
// Get all thread ids of all currently running processes.
std::vector<pid_t> GetAllTids();
#endif

}  // namespace orbit_base

#endif  // ORBIT_BASE_GET_PROCESS_IDS_H