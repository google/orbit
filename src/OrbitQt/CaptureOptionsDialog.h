...
class CaptureOptionsDialog : public QDialog {
 ...
 public:
  ...
  void SetDynamicInstrumentationMethod(orbit_grpc_protos::DynamicInstrumentationMethod method);
  [[nodiscard]] orbit_grpc_protos::DynamicInstrumentationMethod GetDynamicInstrumentationMethod()
      const;
