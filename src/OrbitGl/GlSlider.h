...
class GlSlider : public Pickable, public std::enable_shared_from_this<GlSlider> {
 public:
  ...
  virtual void Draw(PrimitiveAssembler& batcher, bool is_picked) = 0;
 ...
 protected:
  ...
  void DrawBackground(PrimitiveAssembler& batcher, float x, float y, float width, float height);
  void DrawSlider(PrimitiveAssembler& batcher, float x, float y, float width, float height,
