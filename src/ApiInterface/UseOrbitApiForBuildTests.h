...
#define USE_ORBIT_API_SCOPE                               \
  ORBIT_SCOPE("name");                                    \
  ORBIT_SCOPE_WITH_COLOR("name", (orbit_api_color)0xc01); \
  ORBIT_SCOPE_WITH_GROUP_ID("name", 42);                  \
  ORBIT_SCOPE_WITH_COLOR_AND_GROUP_ID("name", (orbit_api_color)0xc01, 42);

#define USE_ORBIT_API_EXCEPT_SCOPE                                         \
  ORBIT_START("name");                                                     \
