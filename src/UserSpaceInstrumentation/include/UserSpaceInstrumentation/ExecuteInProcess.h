...
[[nodiscard]] ErrorMessageOr<uint64_t> ExecuteInProcess(pid_t pid, void* function_address,
                                                        uint64_t param_0 = 0, uint64_t param_1 = 0,
                                                        uint64_t param_2 = 0, uint64_t param_3 = 0,
                                                        uint64_t param_4 = 0, uint64_t param_5 = 0);
...
[[nodiscard]] ErrorMessageOr<uint64_t> ExecuteInProcess(
    ...
    std::string_view function, uint64_t param_0 = 0, uint64_t param_1 = 0, uint64_t param_2 = 0,
    uint64_t param_3 = 0, uint64_t param_4 = 0, uint64_t param_5 = 0);
...
[[nodiscard]] ErrorMessageOr<uint64_t> ExecuteInProcessWithMicrosoftCallingConvention(
    pid_t pid, void* function_address, uint64_t param_0 = 0, uint64_t param_1 = 0,
    uint64_t param_2 = 0, uint64_t param_3 = 0);
