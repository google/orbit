// VulkanTutorialVertexShader.spv was generated from VulkanTutorialShader.vert with glslc
// (https://github.com/google/shaderc).
// This is the content of VulkanTutorialVertexShader.spv as converted with bin2c
// (https://github.com/gwilymk/bin2c).
// Do not edit.

#ifndef VULKAN_TUTORIAL_VULKAN_TUTORIAL_VERTEX_SHADER_H_
#define VULKAN_TUTORIAL_VULKAN_TUTORIAL_VERTEX_SHADER_H_

namespace orbit_vulkan_tutorial {

const size_t kVulkanTutorialVertexShaderSpvLength = 1540;

const uint8_t kVulkanTutorialVertexShaderSpv[kVulkanTutorialVertexShaderSpvLength] = {
...
#endif  // VULKAN_TUTORIAL_VULKAN_TUTORIAL_VERTEX_SHADER_H_
