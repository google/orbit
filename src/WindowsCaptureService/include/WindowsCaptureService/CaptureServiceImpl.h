...
#ifndef WINDOWS_CAPTURE_SERVICE_CAPTURE_SERVICE_IMPL_H_
#define WINDOWS_CAPTURE_SERVICE_CAPTURE_SERVICE_IMPL_H_
...
#endif  // WINDOWS_CAPTURE_SERVICE_CAPTURE_SERVICE_IMPL_H_
