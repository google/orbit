...
#ifndef WINDOWS_CAPTURE_SERVICE_CAPTURE_START_STOP_LISTENER_H_
#define WINDOWS_CAPTURE_SERVICE_CAPTURE_START_STOP_LISTENER_H_
...
#endif  // WINDOWS_CAPTURE_SERVICE_CAPTURE_START_STOP_LISTENER_H_
