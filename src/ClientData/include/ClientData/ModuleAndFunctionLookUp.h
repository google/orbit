...
[[nodiscard]] const std::string& GetFunctionNameByAddress(const ProcessData* process,
...
[[nodiscard]] const std::string& GetModulePathByAddress(const ProcessData* process,
                                                        const ModuleManager* module_manager,
                                                        const CaptureData* capture_data,
                                                        uint64_t absolute_address);
