...
class CaptureData {
 public:
  ...
  [[nodiscard]] std::shared_ptr<ScopeStatsCollection> CreateScopeStatsCollection(
      uint64_t min_tick, uint64_t max_tick) const;
  [[nodiscard]] std::shared_ptr<ScopeStatsCollection> GetAllScopeStatsCollection() const;
