...
class TimerBlock {
 ...
 public:
  ...
  orbit_client_protos::TimerInfo& operator[](std::size_t idx) { return data_[idx]; }
  const orbit_client_protos::TimerInfo& operator[](std::size_t idx) const { return data_[idx]; }
