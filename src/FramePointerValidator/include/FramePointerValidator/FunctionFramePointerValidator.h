...
#ifndef FRAME_POINTER_VALIDATOR_FUNCTION_FRAME_POINTER_VALIDATOR_H_
#define FRAME_POINTER_VALIDATOR_FUNCTION_FRAME_POINTER_VALIDATOR_H_
...
#endif  // FRAME_POINTER_VALIDATOR_FUNCTION_FRAME_POINTER_VALIDATOR_H_
