...
void OrbitService::SetupIntrospection() {
...
void OrbitService::ProcessListThread(std::atomic<bool>* exit_requested) {
  while (!(*exit_requested)) {
    SendProcessList();
    Sleep(2000);
  }
...
void OrbitService::SendProcessList() {
...
void OrbitService::SetupServerCallbacks() {
...
void OrbitService::SendProcess(uint32_t pid) {
...
void OrbitService::SetupTransactionServices() {
...
void OrbitService::TracingBufferThread() {
