...
class Pdb {
 public:
  ...
  [[nodiscard]] std::vector<orbit_client_protos::FunctionInfo*> GetSelectedFunctionsFromPreset(
 ...
 private:
  ...
  std::unordered_map<unsigned long long, orbit_client_protos::FunctionInfo*> m_StringFunctionMap;
};
