...
//-----------------------------------------------------------------------------
//[EventType{ 0, 32, 35, 36 }, EventTypeName{ "Name", "FileCreate",
//"FileDelete", "FileRundown" }]
struct FileIo_Name {
  ULONG64 FileObject;
  wchar_t FileName[1];
...
//-----------------------------------------------------------------------------
//[EventType{ 69, 70, 71, 74, 75 }, EventTypeName{ "SetInfo", "Delete",
//"Rename", "QueryInfo", "FSControl" }]
struct FileIo_Info {
  ULONG64 IrpPtr;
  ULONG64 TTID;
  ULONG64 FileObject;
...
// 0	// File name event.The FileIo_Name MOF class defines the event data for
// this event.
// 32	// File create event.The FileIo_Name MOF class defines the event data
// for this event. 35	// File delete event.The FileIo_Name MOF class defines
// the event data for this event. 36	// File rundown event.Enumerates all
// open files on the computer at the end of the trace session.The FileIo_Name
// MOF class defines the event data for this event. 64	// File create event.The
// FileIo_Create MOF class defines the event data for this event. 72	//
// Directory enumeration event.The FileIo_DirEnum MOF class defines the event
// data for this event. 77	// Directory notification event.The
// FileIo_DirEnum MOF class defines the event data for this event. 69	// Set
// information event.The FileIo_Info MOF class defines the event data for this
// event. 70	// Delete file event.The FileIo_Info MOF class defines the event
// data for this event. 71	// Rename file event.The FileIo_Info MOF class
// defines the event data for this event. 74	// Query file information
// event.The FileIo_Info MOF class defines the event data for this event. 75
// // File system control event.The FileIo_Info MOF class defines the event data
// for this event. 76	// End of operation event.The FileIo_OpEnd MOF class
// defines the event data for this event. 67	// File read event.The
// FileIo_ReadWrite MOF class defines the event data for this event. 68	// File
// write event.The FileIo_ReadWrite MOF class defines the event data for this
// event. 65	// Clean up event.The event is generated when the last handle to
// the file is released.The FileIo_SimpleOp MOF class defines the event data for
// this event.
// 66	// Close event.The event is generated when the file object is freed.The
// FileIo_SimpleOp MOF class defines the event data for this event. 73	// Flush
// event.This event is generated when the file buffers are fully flushed to
// disk.The FileIo_SimpleOp MOF class defines the event data for this event.
