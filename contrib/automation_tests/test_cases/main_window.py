...
class MoveTab(E2ETestCase):
    ...
    def _execute(self, tab_title, tab_name):
        ...
        self.expect_eq(self._count_tabs(right_tab_bar), right_tab_count - 1, "1 tab removed from right pane")
        self.expect_eq(self._count_tabs(left_tab_bar), left_tab_count + 1, "1 tab added to the left pane")
        ...
        self.right_click_move_context(tab_item)
        self.expect_eq(self._count_tabs(right_tab_bar), right_tab_count, "1 tab removed from left pane")
        self.expect_eq(self._count_tabs(left_tab_bar), left_tab_count, "1 tab added to the right pane")
