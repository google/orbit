...
class CaptureEventProcessor {
 ...
 private:
  ...
  void ProcessTracepointSample(const orbit_grpc_protos::TracepointSample& tracepoint_sample);
  ...
  absl::flat_hash_map<uint64_t, orbit_grpc_protos::TracepointInfo> tracepoint_intern_pool;
