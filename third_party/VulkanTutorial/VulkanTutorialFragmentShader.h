// VulkanTutorialFragmentShader.spv was generated from VulkanTutorialShader.frag with glslc
// (https://github.com/google/shaderc).
// This is the content of VulkanTutorialFragmentShader.spv as converted with bin2c
// (https://github.com/gwilymk/bin2c).

#ifndef VULKAN_TUTORIAL_VULKAN_TUTORIAL_FRAGMENT_SHADER_H_
#define VULKAN_TUTORIAL_VULKAN_TUTORIAL_FRAGMENT_SHADER_H_

namespace orbit_vulkan_tutorial {

const size_t kVulkanTutorialFragmentShaderSpvLength = 608;

const uint8_t kVulkanTutorialFragmentShaderSpv[kVulkanTutorialFragmentShaderSpvLength] = {
...
#endif  // VULKAN_TUTORIAL_VULKAN_TUTORIAL_FRAGMENT_SHADER_H_
