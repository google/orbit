...
target_sources(DIA2Dump PUBLIC
    ${DIR}/Callback.h
    ${DIR}/DIA2Dump.h
    ${DIR}/PrintSymbol.h
    ${DIR}/regs.h)

target_sources(DIA2Dump PRIVATE
    ${DIR}/dia2dump.cpp
    ${DIR}/PrintSymbol.cpp
    ${DIR}/regs.cpp)
...
# it should be pulled into OrbitGl.
target_link_libraries(DIA2Dump PUBLIC multicore::multicore concurrentqueue::concurrentqueue oqpi::oqpi xxHash::xxHash cereal)
